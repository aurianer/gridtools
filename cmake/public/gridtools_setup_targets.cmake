...
macro(_gt_setup_targets _config_mode clang_cuda_mode)
    ...
    if (HPX_FOUND)
        # Add a stencil cpu Ifirst target for HPX backend
        ...
        list(APPEND GT_AVAILABLE_TARGETS ${_gt_namespace}stencil_cpu_ifirst_hpx)
        list(APPEND GT_STENCILS cpu_ifirst_hpx)
        # Add a stencil cpu Kfirst target for HPX backend
        # Could not add an alias ifirst_hpx target cause not globally available
        _gt_add_library(${_config_mode} stencil_cpu_kfirst_hpx)
        target_link_libraries(${_gt_namespace}stencil_cpu_kfirst_hpx INTERFACE ${_gt_namespace}gridtools HPX::hpx_no_wrap_main)
        list(APPEND GT_AVAILABLE_TARGETS ${_gt_namespace}stencil_cpu_kfirst_hpx)
        list(APPEND GT_STENCILS cpu_kfirst_hpx)
    endif(HPX_FOUND)
