    ...
    namespace hpx_mc {
        ...
        class execinfo_mc {
          ...
          public:
             ...
             */
            GT_FORCE_INLINE execinfo_block_kserial_mc block(int_t i_block_index, int_t j_block_index) const {
             ...
             * @return An execution info instance with the computed properties.
             */
            GT_FORCE_INLINE execinfo_block_kparallel_mc block(int_t i_block_index, int_t j_block_index, int_t k) const {
                return {i_block_index,
                    j_block_index,
                    k,
                    clamped_block_size(m_i_grid_size, i_block_index, m_i_block_size, m_i_blocks),
